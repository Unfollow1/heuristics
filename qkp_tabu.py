    ...
    def solve(self):
        ...
        while (time.time() - self.start_time) < self.time_limit and iters < self.max_iters:
            ...
            if best_move[0] == 'add':
                ...
                # Marcar movimento reverso como tabu (remover i)
                tabu_list[i] = iters + self.tabu_tenure
                ...
                cur_w -= self.weights[i]
                cur_obj = best_new_obj
                # Marcar movimento reverso como tabu (adicionar i)
                tabu_list[i] = iters + self.tabu_tenure
                ...
                # Ambos ficam tabu
                tabu_list[i] = iters + self.tabu_tenure
                tabu_list[k] = iters + self.tabu_tenure
...
def main():
    ...
    parser.add_argument('--tabu-tenure', type=int, default=20, help='tamanho da lista tabu')
